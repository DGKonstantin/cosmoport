...
public class GetAllTest extends AbstractTest {
    ...
    public void getAllWithFiltersIsUsedMaxSpeedMaxRating() throws Exception {
        ...
        for (int i = 0; i < actual.size(); i++) {
            if (actual.get(i).hashCode() != expected.get(i).hashCode())
                System.out.println(String.format("shipAct: %s\nshipExp: %s", actual.get(i).toString(), expected.get(i).toString()));
            //System.out.println(String.format("act: %s\nexc: %s", actual.get(i).hashCode(), expected.get(i).hashCode()));
            System.out.println();
        }
    ...
    public void getAllWithFiltersNameOrderSpeed() throws Exception {
        ...
        for (int i = 0; i < ships.size(); i++) {
            if (ships.get(i).hashCode() != expected.get(i).hashCode())
                System.out.println(String.format("shipAct: %s\nshipExp: %s", ships.get(i).toString(), expected.get(i).toString()));
            //System.out.println(String.format("act: %s\nexc: %s", actual.get(i).hashCode(), expected.get(i).hashCode()));
            System.out.println();
        }
